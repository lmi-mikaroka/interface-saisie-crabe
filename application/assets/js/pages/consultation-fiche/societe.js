$(() => {
  ...
  const datatable = $('#datatable').DataTable({
    ...
    ajax: {
      ...
      url: BASE_URL + '/consultation-de-fiche-societe/liste',
  ...
  $(document).on('click', '.delete-button', e => {
    ...
    jConfirmRed('Supprimer la sélection', 'La suppression pourra entraîner la perte d\'autres données relatives à celle-ci.\nVeuillez confirmer la suppression', () => {
      ...
      $.ajax({
        ...
        url: BASE_URL + '/operation-suivi-societe/suppression/' + information,
        ...
        success: () => {
          ...
          $.alert('La Cargaison a été supprimé avec succès');
