        ...
        <div class="row">
          <div class="col-md-6" style="border-right: 1px solid #ffc107">
              <div class="row"  style="display:flex; align-items: center" >
                  ...
                  <div >
                    ...
                    <input disabled name="js-zone-corecrabe" id="js-zone-corecrabe" class=" selectpicker custom-select" value="<?= $fiche['nomZone'] ?>">
                  ...
                  <div class="col-md-6 mb-1">
                    ...
                    <input disabled name="js-fokontany" id="js-fokontany" class="custom-select selectpicker" value="<?= $fiche['nomFokontany'] ?>">
                  ...
                  <div class="col-md-6 mb-1">
                    ...
                    <input disabled name="js-village" id="js-village" class="custom-select selectpicker" value="<?= $fiche['nomVillage'] ?>">
          ...
          <div class="col-md-6" style="border-right: 1px solid #ffc107">
                      <div class="row"  style="display:flex; align-items: center">
                        ...
                        <div class="col-md-6 mb-1" >
                            <input type="month" name="js-annee-mois" disabled  class=" form-control selectpicker" id="js-annee-mois" value="<?= $fiche['annee'].'-'.$fiche['moisfiche'] ?>">
                          
                        </div>
                        <div class="col-md-6" ><h6 style="font-weight: bold">Date <span class="text text-red">*</span>:</h6></div>
                        <div class="col-md-6 mb-1" >
                            <input type="date" name="js-date" type="number" class=" form-control selectpicker"id="js-date" value="<?= $fiche['date'] ?>">
                        </div>
                        ...
                        <div class="col-md-6 mb-1" >
                            ...
                            <option value="" hidden selected></option>
                              ...
                              <?php if (isset($enqueteurs) && is_array($enqueteurs)) foreach ($enqueteurs as $enqueteur) { ?>
                                ...
                                <option value="<?= $enqueteur['id'] ?>" <?= $enqueteur['id']==$fiche['enqueteur']?'selected':''  ?>><?= $enqueteur['code'] ?></option>
