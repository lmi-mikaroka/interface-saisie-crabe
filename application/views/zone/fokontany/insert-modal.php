			...
			<div class="modal-body">
				<form autocomplete="off" id="formulaire-insertion">
					...
					<div class="form-group">
						<label for="js-commune-insertion">Commune <span class="text text-red">*</span></label>
						<select name="js-commune" id="js-commune-insertion" class="custom-select">
					...
					<div class="form-group">
						<label for="js-nom-insertion">Nom du Fokontany <span class="text text-red">*</span></label>
