      ...
      <div class="modal-body">
        ...
        <form autocomplete="off" id="js-formulaire-modification">
          ...
          <div class="form-group">
            ...
            <label for="js-label-modification">Nom de l'organisation <span class="text text-red">*</span></label>

            <input type="text" class="form-control" name="js-label" id="js-label-modification">
