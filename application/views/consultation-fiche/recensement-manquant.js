                ...
                if(result.result){
                    ...
                    $.alert({
                        content: function () {
                            var self = this;
                            return $.ajax({
                                url: `${BASE_URL}/recensement/saisie-enquete/insertion-manquant`,
    ...
    function check_info_enquete(){
        ...
        message ="Informations complètes";
            if( form.resident ==null || form.pecheur ==null||form.sexe ==null ||form.age ==null||form.age ==''|| form.pirogue ==null || form.activite.activite1==null || form.engins.engin1 ==null || form.engins.annee1 ==null||form.activite.pourcentage1==null||(form.resident ==0 && form.village_origine ==null)||(form.resident ==1 && form.toute_annee ==null)||(form.resident ==0 && form.periode_mare ==null)||(parseInt(form.activite.activite2)>0 && (form.activite.pourcentage2==null||form.activite.pourcentage2=='') )||(parseFloat(form.activite.pourcentage2)>0 && (form.activite.activite2==null||form.activite.activite2=='') )||(parseInt(form.activite.activite3)>0 && (form.activite.pourcentage3==null||form.activite.pourcentage3 =='') )||(parseFloat(form.activite.pourcentage3)>0 && (form.activite.activite3==null||form.activite.activite3=='') )||(parseInt(form.engins.engin2)>0 && (form.engins.annee2==null||form.activite.annee2 =='') )||(parseInt(form.engins.annee2)>0 && (form.engins.engin2==null||form.engins.engin2 =='') )){
                result = false;
