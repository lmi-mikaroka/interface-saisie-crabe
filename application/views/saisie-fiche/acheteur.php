    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6 offset-md-3 col-lg-4 offset-lg-4 col-sm-12">
          ...
          <div class="card card-default" id="information-sur-la-fiche">

            <div class="card-header card-acheteur">
            ...
            <div class="card-body">
              ...
              <form autocomplete="off" id="js-formulaire">
                ...
                <div class="text-center" style="display: none;" id="actualisation-enqueteur">
                  ...
                  <p><strong>Actualisation des acheteurs...</strong></p>

                </div>

                <div class="form-group" id="champ-insertion-enqueteur">

                  <label for="js-enqueteur">Code de l'Acheteur <span class="text text-red">*</span></label>
                ...
                <div class="form-group">
                  ...
                  <input name="js-date-expedition" type="date" id="js-date-expedition" class="form-control">
