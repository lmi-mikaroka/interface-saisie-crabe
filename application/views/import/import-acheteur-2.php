...
<div class="container-fluid">
  ...
  <div class="row mb-2">
    ...
    <div class="col-sm-6">
      ...
      <h1>Importer les données Acheteurs depuis EXCEL/CSV (Deuxième solution)</h1>
...
<div class="container-fluid">
	...
	<div class="col-12">
	    <a href="http://vps-a8d8821c.vps.ovh.net/owncloud/index.php/s/8Wp0I4ZLdr2Alju" target="_blank">Télécharger la structure modèle de données à exporter ici</a>
	</div>
    </div>
</div>
</section>
