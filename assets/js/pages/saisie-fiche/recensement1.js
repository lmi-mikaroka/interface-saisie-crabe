        ...
        $.map(enquetesInverse, function(x,y){
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                   <div> <label>Résident:       </label> </div>
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn btn-sm btn-outline-secondary `+(form.enquete[enquetesInverse.length-y-1].resident == '0' ? `active`:``)+`">
                                ...
                                <label class="btn btn-sm btn-outline-secondary `+(form.enquete[enquetesInverse.length-y-1].resident == '1' ?`active`:``)+`">
                ...
                <div class="col-md-3">
                  ...
                  <label>Sexe <span id="warning-sexe${enquetesInverse.length-y-1}"></span></label>
                  <div >
                ...
                <div><label>Pirogue</label></div>
                    ...
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                            ...
                            <label class="btn btn-sm btn-outline-secondary `+(form.enquete[enquetesInverse.length-y-1].pirogue == '0'?`active`:``)+`">
                            ...
                            <label class="btn btn-sm btn-outline-secondary `+(form.enquete[enquetesInverse.length-y-1].pirogue == '1'?`active`:``)+`">
                            ...
                            <label class="btn btn-sm btn-outline-secondary  `+(form.enquete[enquetesInverse.length-y-1].pirogue == '2'?`active`:``)+`">
                ...
                <div class="col-md-3"  id="div-crabe-toute-annee${enquetesInverse.length-y-1}" >

                    <div><label>Crabe toute l'année</label></div>
                    <div class="btn-group btn-group-toggle" data-toggle="buttons">
                    
                    <label class="btn btn-sm btn-outline-secondary `+(form.enquete[enquetesInverse.length-y-1].toute_annee == '0'?`active`:``)+`">
                    ...
                    <label class="btn btn-sm btn-outline-secondary `+(form.enquete[enquetesInverse.length-y-1].toute_annee == '1'?`active`:``)+`">
                ...
                <div class="col-md-3" id='div-periode-mois${enquetesInverse.length-y-1}' `+` id="div-periode-mois${enquetesInverse.length-y-1}" `+(form.enquete[enquetesInverse.length-y-1].toute_annee==1?`style='display:none'`:`style='display:block'`)+`  >
                  <div class="form-group w-50 " >
                  <label>Période</label>
             ...
             <div class="col-md-4" >
                ...
                <div class="col-md-4">
                    <div class="form-goup">
                        ...
                        <select class="custom-select form-sm" id="js-annee1${enquetesInverse.length-y-1}" name="js-annee1${enquetesInverse.length-y-1}" onchange="change_annee1(${enquetesInverse.length-y-1})">
                            <option value=''></option>
           ...
           <div class="col-md-6" >
                <div class="form-group">
                    ...
                    <input type="number" id="js-activite1-pourcent${enquetesInverse.length-y-1}" name="js-activite1-pourcent${enquetesInverse.length-y-1}" class="custom-select" onkeyup="change_pourcentage1(${enquetesInverse.length-y-1})" value="${form.enquete[enquetesInverse.length-y-1].activite.pourcentage1}" step="any"/>
                </div>
           </div>
           ...
           <div class="col-md-2">
                <div class="form-group">
                    <label>Pourcentage</label>
                    <input type="number" name="js-activite2-pourcent${enquetesInverse.length-y-1}" id="js-activite2-pourcent${enquetesInverse.length-y-1}" class="custom-select" onkeyup="change_pourcentage2(${enquetesInverse.length-y-1})" value="${form.enquete[enquetesInverse.length-y-1].activite.pourcentage2}" step="any"/>
                </div>
           </div>
           ...
           <div class="col-md-2">
                <div class="form-group">
                    <label>Pourcentage</label>
                    <input type="number" name="js-activite3-pourcent${enquetesInverse.length-y-1}" id="js-activite3-pourcent${enquetesInverse.length-y-1}" class="custom-select" onkeyup="change_pourcentage3(${enquetesInverse.length-y-1})" value="${form.enquete[enquetesInverse.length-y-1].activite.pourcentage3}" step="any" />
                </div>
           </div>
   ...
   function check_info_enquete(){
    ...
    for(index=0;index<form.enquete.length;index++){
        ...
        if(form.enquete[index].resident==null || (form.enquete[index].resident==0 && form.enquete[index].village_origine == null )|| form.enquete[index].age == null || form.enquete[index].sexe==null || form.enquete[index].pirogue==null || form.enquete[index].toute_annee==null || form.enquete[index].type_mare==null || (form.enquete[index].toute_annee==0 && form.enquete[index].periode_mois==null) || form.enquete[index].engins.engin1==null || form.enquete[index].engins.annee1==null || form.enquete[index].activite.activite1==null || form.enquete[index].activite.pourcentage1 == null ||(parseInt(form.enquete[index].activite.activite2)>0 && (form.enquete[index].activite.pourcentage2==null||form.enquete[index].activite.pourcentage2=='') )||(parseInt(form.enquete[index].activite.activite3)>0 && (form.enquete[index].activite.pourcentage3==null||form.enquete[index].activite.pourcentage3 =='') )||(parseFloat(form.enquete[index].activite.pourcentage3)>0 && (form.enquete[index].activite.activite3==null||form.enquete[index].activite.activite3=='') )||(parseInt(form.enquete[index].engins.engin2)>0 && (form.enquete[index].engins.annee2==null||form.enquete[index].activite.annee2 =='') )||(parseInt(form.enquete[index].engins.annee2)>0 && (form.enquete[index].engins.engin2==null||form.enquete[index].engins.engin2 =='') ) ){
            result = false;
...
function change_village_orgine(key){
    ...
    if(origine !=''){
        ...
        if(parseInt(origine)>0){
            ...
            var pecheurs = ListePecheur_origine(form.village,origine);
	    ...
	    var pecheurs = ListePecheur(form.village);
            $.map(pecheurs,function(pecheur,b){
                chainePecheur += `<option value="${pecheur.idpecheur}">${pecheur.nom}</option>`
            })
        ...
        if(parseInt(val_pecheur)>0){
            ...
            detail_pecheur(val_pecheur).then(pecheur => {
                ...
                if(pecheur['sexe']!=null){
                    ...
                    $(`#warning-sexe${key}`).html('');   
                }
                else{
                    form.enquete[key].sexe=null;
                    $(`#warning-sexe${key}`).html(`<span class="badge badge-danger"><i class="fa fa-times"></i> </badge>`);    
                }
               

                if(pecheur['datenais']>0){
                    ...
                    $(`[name=js-age${key}]`).removeClass('is-invalid');
                }
                else{
                    $(`[name=js-age${key}]`).val(null);
                    form.enquete[key].age=null;
                    $(`[name=js-age${key}]`).addClass('is-invalid');
                }
...
function change_age(key){
    var age = $(`[name=js-age${key}]`).val();
    if(age>0){
		form.enquete[key].age= $(`[name=js-age${key}]`).val();
	}
    else{ form.enquete[key].age= null; }
...
function change_engin1(key){
    ...
    form.enquete[key].engins.engin1 = null;
    ...
    if(x !=''){
	form.enquete[key].engins.engin1 = x;
     }
    recupereMare(form.enquete[key].engins.engin1,form.enquete[key].engins.engin2,key);
    warning(key);
...
function change_engin2(key){
    ...
    form.enquete[key].engins.engin2 = null;
    var engin2 = $(`[name=js-engin2${key}]`).val();
	if(engin2 != ''){
		form.enquete[key].engins.engin2 = engin2;	
	}
    recupereMare(form.enquete[key].engins.engin1,form.enquete[key].engins.engin2,key);
    warning(key);
console.log(form.enquete)
  
}
function change_annee1(key){
    var annee1 = $(`[name=js-annee1${key}]`).val();
    form.enquete[key].engins.annee1 = null;
    if(annee1 != ''){
	form.enquete[key].engins.annee1 = annee1;
	}
    warning(key);
...
function change_annee2(key){
    ...
    var annee2 = $(`[name=js-annee2${key}]`).val();
    form.enquete[key].engins.annee2 = null;
    if(annee2 != ''){
	form.enquete[key].engins.annee2 = annee2;
	}
    warning(key);
...
function change_activite1(key){
    ...
    var x = $(`[name=js-activite1${key}]`).val();
      ...
      $(`[name=js-activite3${key}]  option[value="${x}"]`).attr('disabled',true);
       if( x != ''){
	form.enquete[key].activite.activite1 = x;	
	}
      warning(key);
...
function change_activite2(key){
    var act2 = $(`[name=js-activite2${key}]`).val();
...
function change_activite3(key){
    ...
    var act3 = $(`[name=js-activite3${key}]`).val();
...
function change_pourcentage1(key){
    ...
    var p1= $(`[name=js-activite1-pourcent${key}]`).val();
    if(p1 != '')
    {
...
function change_pourcentage2(key){
    ...
    var p2= $(`[name=js-activite2-pourcent${key}]`).val();
    if(p2 != '')
    {
...
function invalideChamp(index){
    ...
    if(( form.enquete[index].engins.engin2 ==null && form.enquete[index].engins.annee2>0)){
    ...
    if(( form.enquete[index].activite.activite2 ==null && parseFloat(form.enquete[index].activite.pourcentage2)>0)){
    ...
    if(( form.enquete[index].activite.activite3 ==null && parseFloat(form.enquete[index].activite.pourcentage3)>0)){
        $(`[name=js-activite3${index}]`).addClass('is-invalid');
    }else{
        $(`[name=js-activite3${index}]`).removeClass('is-invalid');
    }

    if (form.enquete[index].type_mare == null){
        $(`[name=js-periode-mare${index}]`).addClass('is-invalid');
    }
    else{
        $(`[name=js-periode-mare${index}]`).removeClass('is-invalid');
    }

    if((form.enquete[index].toute_annee==0) && (form.enquete[index].periode_mois ==null)){
        $(`[name=js-periode-mois${index}]`).addClass('is-invalid');
    }
    else{
        $(`[name=js-periode-mois${index}]`).removeClass('is-invalid');
    }


    if(form.enquete[index].sexe ==null){
        $(`#warning-sexe${index}`).html(`<span class="badge badge-danger"><i class="fa fa-times"></i> </badge>`);   
    }
    else{
        $(`#warning-sexe${index}`).html('');
    }
...
function ListePecheur_origine(village,origine){
    ...
    $.ajax({
        ...
        data: {village:village,origine:origine},

        url: `${BASE_URL}/pecheur/liste-pecheur-non-recenser-origine`,
...
function ListePecheur(village){
    ...
    $.ajax({
        ...
        url: `${BASE_URL}/pecheur/liste-pecheur-non-recenser`,
...
function recupereMare(engin1,engin2,key){
    ...
    if(type_mare == 0){
    form.enquete[key].type_mare = 'Mortes eaux';
    }
    if(type_mare == 1){
    form.enquete[key].type_mare='Vives eaux';
    }
    if(type_mare == 2){
    form.enquete[key].type_mare='Toutes marées';
    }
